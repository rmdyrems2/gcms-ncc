...
--
-- Host: localhost
-- Generation Time: Oct 27, 2023 at 12:38 PM
...
CREATE TABLE `appointments` (
  ...
  `apmntMessage` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `appointment_date` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `appointment_time` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(4, '23-345603', 'Counseling', 'Please bring your ID you motherfucker! :)', '2023-10-16', '00:23:00.000000', 'Pending', '2023-10-15 14:23:11'),
(5, '23-345603', 'Testing', 'ey', '2023-10-17', '00:30:00.000000', 'In Progress', '2023-10-15 14:29:38'),
(6, '23-345603', 'Refferal', 'Hi there scot!', '2023-10-16', '12:01:00.000000', 'Completed', '2023-10-15 15:31:48'),
(7, '12345-2123', 'Counseling', 'Test', '2023-10-17', '13:32:00.000000', 'Pending', '2023-10-16 02:42:54'),
(8, '12345-2123', 'Counseling', 'Hi', '2023-10-17', '01:23', 'In Progress', '2023-10-16 02:45:19');
...
CREATE TABLE `messages` (
  ...
  `message_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tblcounseling` (
  `ID` int NOT NULL,
  `StudentName` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `CounselingReason` mediumtext CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `CounselingDate` date DEFAULT NULL,
  `CounselingNotes` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `PupilCommitment` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(31, 'Mary Mae', 'Dionzon', 'Paran', 'Mae', 'marymae@gmail.com', '14', 'Female', '3rd', '2001-02-10', 'Nagcasunog, Bindoy, Negros, Orientall', 'Nagcasunog, Bindoy, Negros, Oriental', '123456789', 'Roger That', 'Marivic Gwapa', 946656565, 945544566, 'Nagcasunog, Bindoy, Negros, Orientall', 'marymae-mcc', '1252160b3e8f43f2fe2d23001d5152c8', '2eff6b0c646aa1ab06b64ba3d5818a741697353185.png', '2023-10-15 06:59:45'),
(32, 'Riza Mae', 'Carcuevas', 'Alivio', 'Riz', 'riza@gmail.com', '12', 'Female', '2', '2312-03-12', 'Nagcasunog, Bindoy, Negros, Orientall', 'B. Suico St,. Tabok Rd, Tingub Mandaue City', '12345-2123', 'Felix Jr Camiguel', 'Mrasdaskjd kajsda', 945664565, 94565464, 'B. Suico St,. Tabok Rd, Tingub Mandaue City', 'riza21', '8041fcaa002f024b5648b2e7e6e15680', '8d6ea6c80eb6e5b2274aa40d403b03921697356284.jpg', '2023-10-15 07:51:24'),
(33, 'Jeremy', 'Zues', 'Irix', 'Jer', 'jeremy@gmail.com', '17', 'Male', '1', '2001-10-21', 'Nagcasunog, Bindoy, Negros, Orientall', 'Nagcasunog, Bindoy, Negros, Oriental', '23-345603', 'Felix Jr Camiguel', 'Marivic Gwapa', 906635984, 906306843, 'Tingub Mandaue City', 'realjoker2', 'fd16e8cb273b3d77635e416fb300c4a2', '2eff6b0c646aa1ab06b64ba3d5818a741697364304.png', '2023-10-15 10:05:04');
