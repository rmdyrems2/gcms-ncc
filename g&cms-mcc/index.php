...
<head>
    <title>MCC - GCMS | Home Page</title>
...
<body>
            ...
            <div class="slider">
                <div class="callbacks_container">
                    <ul class="rslides" id="slider">
                        <li>
                            <h3 class="h3-header">Empowering <br>Student Success</h3>
    ...
    <div class="chat-bot">
        ...
        Typebot.initBubble({
            typebot: "customer-support-copy-rs2py1p",
            theme: {
                button: {
    ...
    <div class="testimonials">
        <div class="container">
            <div class="testimonial-nfo">
                <h3 style="color:black">Public Notice/s</h3>
