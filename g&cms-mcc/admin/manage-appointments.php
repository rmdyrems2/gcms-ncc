...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    if (isset($_GET['delid'])) {
        ...
        $sql   = "delete from appointments where id=:rid";
...
<head>
    ...
    <title>GCMS-MCC | Manage Appointments</title>
    <!-- plugins:css -->
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="shortcut icon" type="image/x-icon" href="../images/logo-mcc.png" />
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex align-items-center mb-4">
                                        <h4 class="card-title mb-sm-0">Manage Appointment</h4>
                                        <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> View all Appointment</a>
                                    </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $ret                    = "SELECT id FROM appointments";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo htmlentities($row->apmnttype); ?>
                                                    </td>

                                                    <td>
                                                        <?php echo htmlentities($row->apmntMessage); ?>
                                                    </td>
                                                    <td>
                                                        <?php echo htmlentities($row->appointment_date); ?>
                                                    </td>
                                                    <td>
                                                        <?php echo htmlentities($row->appointment_time); ?>
                                                    </td>
                                                    <td>
                                                        <?php echo htmlentities($row->appointment_status); ?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div><a
                                                                href="edit-appointment-detail.php?editid=<?php echo htmlentities($row->id); ?>"><i
                                                                    class="icon-eye"></i></a>
                                                            || <a
                                                                href="manage-appointments.php?delid=<?php echo ($row->id); ?>"
