...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  <head>
    ...
    <title>MCC - GCMS | Update Contact Us</title>
    <!-- plugins:css -->
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) { ?>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="email" id="email" required="true" value="<?php echo $row->Email; ?>"
                              class="form-control">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputName1">Mobile Number:</label>
                            <input type="text" name="mobnum" id="mobnum" required="true"
                              value="<?php echo $row->MobileNumber; ?>" class="form-control" maxlength="10" pattern="[0-9]+">
                          </div>
                          <?php $cnt = $cnt + 1;
                        }
                      } ?>
