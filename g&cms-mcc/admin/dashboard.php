...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    <head>
        ...
        <title>MCC - GCMS | Dashboard</title>
                                        ...
                                        <div class="row report-inner-cards-wrapper">
                                            <div class=" col-md -6 col-xl report-inner-card">
                                                <div class="inner-card-text">
                                                    ...
                                                    ?>
                                                    <span class="report-title">Class</span>
                                                    <h4>
                                            ...
                                            <div class="col-md-6 col-xl report-inner-card">
                                                <div class="inner-card-text">
                                                    ...
                                                    ?>
                                                    <span class="report-title">Students</span>
                                                    <h4>
                                            ...
                                            <div class="col-md-6 col-xl report-inner-card">
                                                <div class="inner-card-text">
                                                    ...
                                                    ?>
                                                    <span class="report-title">Class Notice</span>
                                                    <h4>
                                                        <?php echo htmlentities($totnotice); ?>
                                                    </h4>
                                                    <a href="manage-notice.php"><span class="report-count"> View
                                                            more...</span></a>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-xl report-inner-card">
                                                <div class="inner-card-text">
                                                    ...
                                                    ?>
                                                    <span class="report-title">Public Notice</span>
                                                    <h4>
                                                        <?php echo htmlentities($totpublicnotice); ?>
                                                    </h4>
                                                    <a href="manage-public-notice.php"><span class="report-count"> View
                                                            more...</span></a>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-xl report-inner-card">
                                                <div class="inner-card-text">
                                                    ...
                                                    $totappointments = $query5->rowCount();
                                                    ?>
                                                    <span class="report-title">Appointments</span>
                                                    <h4>
                                                        <?php echo htmlentities($totappointments); ?>
                                                    </h4>
                                                    <a href="manage-appointments.php"><span class="report-count"> View
                                                            more...</span></a>
                                                </div>
                                                <div class="inner-card-icon bg-primary">
                                                    <i class="icon-doc"></i>
