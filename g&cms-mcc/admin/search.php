                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input id="searchdata" type="text" name="searchdata" required="true"
                                                    class="form-control"
                                                    placeholder="Search by Name or ID (make sure there is no extra space)">
                                            </div>
                                            ...
                                            <div class="table-responsive border rounded p-1">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $total_pages = ceil(
                                                            $total_rows / $no_of_records_per_page
                                                        );
                                                        $sql         = "SELECT tblstudent.StuID,tblstudent.ID 
                            as sid,tblstudent.FirstName,tblstudent.MiddleName,
                            tblstudent.LastName,tblstudent.StudentEmail,tblstudent.DateofAdmission,tblclass.ClassName,tblclass.Section 
                            from tblstudent join tblclass on tblclass.ID=tblstudent.StudentClass 
                            where tblstudent.StuID like  '$sdata%' or tblstudent.FirstName like  '$sdata%' or tblstudent.MiddleName 
                            like  '$sdata%'or tblstudent.LastName like  '$sdata%' or tblstudent.StudentEmail like  '$sdata%' 
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $row) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div><a href="edit-student-detail.php?editid=<?php echo htmlentities(
                                                                            $row->sid,
