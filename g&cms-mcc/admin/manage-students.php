...
<head>
    ...
    <title>MCC - GCMS | Manage Students</title>
    <!-- plugins:css -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex align-items-center mb-4">
                                        ...
                                        <form class="text-dark ml-auto mb-3 mb-sm-0" action="print-students.php"
                                            method="post" target="_blank">
                                            <button class="icon-printer print-button" type="submit"> Print
                                                Records</button>
                                        </form>
                                    </div>
                                    <style>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $sql         = "SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.FirstName, tblstudent.MiddleName, tblstudent.LastName, tblstudent.NickName, tblstudent.StudentEmail,tblstudent.DateofAdmission,tblclass.ClassName,tblclass.Section from tblstudent join tblclass on tblclass.ID=tblstudent.StudentClass LIMIT $offset, $no_of_records_per_page";
                                                    $query       = $dbh->prepare($sql);
                                                    $query->execute();
