                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="student_id" class="form-control" required='true'>
                                                ...
                                                <option value="<?php echo htmlentities($row1->StuID); ?>">
                                                    ...
                                                    <?php echo htmlentities($row1->StuID); ?>
                                                </option>
                                        ...
                                        <div class="appointmentDate">
                                            ...
                                            <br>
                                            <input type="date" id="date" name="appointmentD"
                                                value="<?php echo $row->appointment_date; ?>">
                                        </div>
                                        <div class="appointmentTime">
                                            <label for="time">Time:</label>
                                            <br>
                                            <input type="time" id="time" name="appointmentT"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="text-area-resize form-control" name="apmntM"
                                                required='true'><?php echo htmlentities($row->apmntMessage); ?></textarea>
                                        </div>
