...
if (strlen($_SESSION["sturecmsaid"] == 0)) {
  ...
  if (isset($_POST["submit"])) {
    ...
    $ret =
      "select UserName from tblstudent where UserName=:uname || StuID=:stuid";
    ...
    if ($query->rowCount() == 0) {
      ...
      if (!in_array($extension, $allowed_extensions)) {
        ...
        $sql =
          "insert into tblstudent(FirstName,MiddleName,LastName,NickName,StudentEmail,StudentClass,Gender,DOB,POB,CurrentAdd,BirthOrder,StuID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:firstname,:middlename,:lastname,:nickname,:stuemail,:stuclass,:gender,:dob,:curadd,:pob,:bo,:stuid,:fname,:mname,:connum,:altconnum,:address,:uname,:password,:image)";
        $query = $dbh->prepare($sql);
        $query->bindParam(":firstname", $firstname, PDO::PARAM_STR);
        $query->bindParam(":middlename", $middlename, PDO::PARAM_STR);
        $query->bindParam(":lastname", $lasttname, PDO::PARAM_STR);
        ...
        $query->bindParam(":bo", $bo, PDO::PARAM_STR);
        $query->bindParam(":curadd", $curadd, PDO::PARAM_STR);
        $query->bindParam(":stuid", $stuid, PDO::PARAM_STR);
  ...
  <head>
    ...
    <title>MCC - GCMS| Add Students</title>
    <!-- plugins:css -->
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="images" class="drop-container">
                          <span class="drop-title">Drop files here (2x2 ID Picture/Formal attire)</span>
                          or
                          <input type="file" name="image" id="images" accept="image/*" required="true">
                        </label>
                      </div>
                      ...
                      <div class="form-group1">
                        ...
                        <input type="text" name="middlename" value="" class="form-control" required='true'>

                      </div>
                      <div class="form-group1">
                        <label for="exampleInputName1">Last Name</label>
                        <input type="text" name="lasttname" value="" class="form-control" required='true'>

                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Nickname</label>
                        <input type="text" name="nickname" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Course with Major & Yr.</label>
                        <select name="stuclass" class="form-control" required='true'>
                          ...
                          foreach ($result2 as $row1) { ?>
                            <option value="<?php echo htmlentities($row1->ID); ?>"><?php echo htmlentities(
                                 $row1->ClassName
                               ); ?>     <?php echo htmlentities($row1->Section); ?></option>
                          <?php }
                          ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="pob" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Birth Order Among Siblings</label>
                        <input type="text" name="bo" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Current Address</label>
                        <input type="text" name="curadd" value="" class="form-control" required='true'>
                      </div>
                      <br>
